...
export default function RegisterUser() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post("http://localhost:3000/api/auth/user/register", data, {
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="flex items-start pt-1">
              <input
                ...
                name="terms"
                type="checkbox"
                className="h-4 w-4 mt-0.5 rounded border-gray-300 text-emerald-600 focus:ring-emerald-500/40 focus:ring-offset-2 dark:border-neutral-600 dark:bg-neutral-800 dark:focus:ring-offset-neutral-900 transition-colors duration-200"
              />
