...
const ReelItem = ({
  ...
  const { videoRef, isPlaying, togglePlay } = useVideoAutoPlay(
    0.6,
    isGloballyMuted,
  ...
  console.log(reel, "kadjfhkadjfhjkadshkfhjakdfhkahdfkj");

  return (
    <div
      className={`reel-item ${fromProfile ? "h-full" : "h-screen"} w-full relative bg-black flex items-center justify-center`}
    >
      ...
      {/* Bottom Partner Info */}
      <div className="absolute bottom-[-1px] left-0 right-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent p-6 pt-16">
        <div className="flex items-end justify-between">
          ...
          <div className="flex-1 mr-4">
            ...
            <p className="text-gray-200 text-sm mb-3 line-clamp-2">
              {reel.description ||
                "Discover this incredible offer from our partner"}
            </p>
            {!fromProfile && (
              <div className="flex gap-4 *:rounded *:px-2 *:py-1 text-white *:min-w-[6rem] *:text-center">
                <Link
                  to={`/partner/profile/${reel.createdBy}`}
